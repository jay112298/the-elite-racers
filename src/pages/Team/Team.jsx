      ...
      <>
        ...
        <TeamWrapper>
          ...
          <div className="members-wrapper">
            <div className="top">
              <div className="left"><div className="text">Our <span>legacy</span> holders</div><div className="shape"></div></div>
              <div className="right"><img src={qualitiesSvg} alt="Qualities" /></div>
            </div>
            <div className="cards-member">
              {
                people.slice(3).map(member => <TeamCard image={member.imageUrl} name={member.name} role={member.role} />)
              }
            </div>
          </div>
