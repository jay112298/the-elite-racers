            ...
            <div className="info-section">
                <div className="calendar" onClick={handleCalendarTextClick}>
                    <div className="car-wrapper">
                        <div className="text" style={{ cursor: 'pointer' }} onClick={() => handleNavigation('/about')} >2024<br /><span>Calendar</span></div>
                ...
                <div className="venue">
                    ...
                    <div className="body">
                        <div className="img" style={{ backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}></div>
                    </div>
